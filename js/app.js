...
const apiUrl = `https://randomuser.me/api/?results=${employeeNum}&inc=name,
picture, email, location, phone, dob &noinfo &nat=US`; //api + filters
// hold DOM elements
    ...
    employees.forEach((employee, index) => {
        ...
        employeeHTML += `
            <div class='employee-card' data-index='${index}'>
                ...
                alt='a portrait of ${name.first} ${name.last}'>
